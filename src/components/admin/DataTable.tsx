                    ...
                    <tbody>
                        {isLoading ? (
                            ...
                            sortedData.map((item, i) => (
                                <tr
                                    key={i}
                                    className={`hover:bg-white/[0.03] transition-colors duration-150 ${i < sortedData.length - 1 ? "border-b border-white/[0.03]" : ""}`}
                                >
                                    {columns.map((col) => (
                ...
                <div className="flex items-center justify-between px-4 py-3 border-t border-white/5">
                    ...
                    <div className="flex items-center gap-1.5">
                        <button
                            ...
                            disabled={page <= 1}
                            className="px-3 py-1.5 rounded-lg text-xs font-bold bg-white/5 hover:bg-white/10 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
                        >
                            ← Prev
                        </button>
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-8 h-8 rounded-lg text-xs font-bold transition-all ${pageNum === page
                                        ...
                                        : "bg-white/5 hover:bg-white/10 text-foreground-secondary/60"
                                        }`}
                                >
                                    {pageNum}
                                </button>
