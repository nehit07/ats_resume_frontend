...
export function AnimatedBackground() {
    ...
    useEffect(() => {
        const updatePositions = () => {
            // Different easing for each blob - creates layered effect
            const ease1 = 0.035; // Fastest
            const ease2 = 0.028;
            const ease3 = 0.022;
            const ease4 = 0.016;
            const ease5 = 0.012; // Slowest
    ...
    return (
        <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
            ...
            />
            {/* Blob 5 - Cyan, top-right, new, slowest */}
            <div
